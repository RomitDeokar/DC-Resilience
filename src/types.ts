...
export function configError(c: Config): string {
  ...
  if (sim.dependent_failures&&sim.common_cause_target==='application'&&!c.it.enabled) return 'Shared application failures require the IT service model to be enabled.'
