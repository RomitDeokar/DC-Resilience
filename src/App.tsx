...
import { availability, DEFAULT_CONFIG, number, configError, normalizeConfig, inr, type Config, type FacilityState, type Page, type Rate, type Run } from './types'
...
export default function App() {
  ...
  function scenario(s: string) {
    ...
    if(['server','os','servers','storage','network','application','surge'].includes(s)){void inject(ids,`Scenario: ${s==='os'?'OS/hypervisor crash on server node (same capacity impact)':s}`);return}
